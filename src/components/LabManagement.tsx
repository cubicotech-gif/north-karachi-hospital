        ...
        <div class="page">
          ...
          <div class="patient-section">
            <div class="patient-grid">
              ...
              <div class="patient-item" style="background: #A2DFF7; padding: 8px; border-radius: 4px;"><span class="patient-label" style="color: #005F6B;">MR Number:</span><span style="font-weight: bold; color: #005F6B;">${selectedPatient.mrNumber || 'N/A'}</span></div>
